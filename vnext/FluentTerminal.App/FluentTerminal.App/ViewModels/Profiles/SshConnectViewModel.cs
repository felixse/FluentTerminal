...
namespace FluentTerminal.App.ViewModels.Profiles
{
    ...
    public class SshConnectViewModel : ProfileProviderViewModelBase
    {
        ...
        public SshConnectViewModel(ISettingsService settingsService,
            ITrayProcessCommunicationService trayProcessCommunicationService, IFileSystemService fileSystemService,
            SshProfile original = null) : base(settingsService, true,
        ...
        {
            var vm = new SshConnectViewModel(settingsService, trayProcessCommunicationService,
                fileSystemService)
            {
                Host = uri.Host,
