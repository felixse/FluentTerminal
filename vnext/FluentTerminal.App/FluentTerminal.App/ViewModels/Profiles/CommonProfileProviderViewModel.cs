...
namespace FluentTerminal.App.ViewModels.Profiles
{
    ...
    public class CommonProfileProviderViewModel : ProfileProviderViewModelBase
    {
        ...
        public CommonProfileProviderViewModel(ISettingsService settingsService,
            IFileSystemService fileSystemService, ShellProfile original = null) : base(settingsService,
            true, original)
        {
