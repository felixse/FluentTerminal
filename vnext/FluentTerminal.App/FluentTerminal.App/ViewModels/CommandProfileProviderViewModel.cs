...
namespace FluentTerminal.App.ViewModels
{
    public class CommandProfileProviderViewModel : ProfileProviderViewModelBase
    {
        ...
        public CommandProfileProviderViewModel(ISettingsService settingsService, 
            ITrayProcessCommunicationService trayProcessCommunicationService, ICommandHistoryService historyService,
            ShellProfile original = null) : base(settingsService, false,
        ...
        {
            var vm = new CommandProfileProviderViewModel(settingsService,
