...
namespace FluentTerminal.App.ViewModels
{
    public class SettingsViewModel : ObservableObject
    {
        public SettingsViewModel(ISettingsService settingsService, IDefaultValueProvider defaultValueProvider, IDialogService dialogService,
            ...
            IFileSystemService fileSystemService, IStartupTaskService startupTaskService,
            ...
            IImageFileSystemService imageFileSystemService)
        {
            ...
            Profiles = new ProfilesPageViewModel(settingsService, dialogService, defaultValueProvider, fileSystemService);
            ...
            SshProfiles = new SshProfilesPageViewModel(settingsService, dialogService, fileSystemService, trayProcessCommunicationService, containers.HistoryContainer);
        }
