...
namespace FluentTerminal.App.Pages
{
    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        public double CoreTitleBarHeight => 42; // _coreTitleBar.Height; todo
        ...
        public Thickness CoreTitleBarPadding
        {
            get
            {
                ...
                {
                    return new Thickness { Left = 200 , Right = 200 };
                }
                else
                {
                    return default;
        ...
        {
            if (e.WindowActivationState != WindowActivationState.Deactivated && TerminalContainer.Content is TerminalView terminal)
            {
        ...
        private void TabBar_TabDraggingCompleted(object sender, TerminalViewModel model)
        {
            ...
            {
                //ViewModel.ApplicationView.TryCloseAsync(); todo
            }
        }
        ...
        private async void TabDropArea_Drop(object sender, DragEventArgs e)
        {
            if (e.DataView.Properties.TryGetValue(Constants.TerminalViewModelStateId, out object stateObj) && stateObj is string terminalViewModelState)
            {
                ...
                ViewModel.AddTab(terminalViewModelState, ViewModel.Terminals.Count);
            }
        }
