...
reg add "HKCU\Software\Classes\Directory\shell\Open Fluent Terminal here" /v icon /t REG_SZ /d "%USERPROFILE%\Pictures\Icons\FluentTerminal.ico" /f
...
reg add "HKCU\Software\Classes\Directory\Background\shell\Open Fluent Terminal here" /v icon /t REG_SZ /d "%USERPROFILE%\Pictures\Icons\FluentTerminal.ico" /f
...
reg add "HKCU\Software\Classes\Drive\shell\Open Fluent Terminal here" /v icon /t REG_SZ /d "%USERPROFILE%\Pictures\Icons\FluentTerminal.ico" /f
...
reg add "HKCU\Software\Classes\LibraryFolder\Background\shell\Open Fluent Terminal here" /v icon /t REG_SZ /d "%USERPROFILE%\Pictures\Icons\FluentTerminal.ico" /f
