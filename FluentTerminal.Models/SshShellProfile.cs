...
{
    public class SshShellProfile : ShellProfile, ISshConnectionInfo
    {
        ...
        public SshShellProfile() { }

        public SshShellProfile(SshShellProfile other) : base(other)
        {
            Host = other.Host;
        ...
        {
            if (!(other is SshShellProfile otherSsh))
            {
                return false;
            }
